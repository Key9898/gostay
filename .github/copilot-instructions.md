# GoStay Project Rules for GitHub Copilot
...
3. `CHANGELOG.md` - Track all changes made to the project
4. `SESSION_SUMMARY.md` - Current session progress and context
...
- Tailwind CSS 4.1.17 + DaisyUI (nord theme)
- Firebase (Auth, Firestore, Storage)
- Vercel Hosting
- Cloudinary (images) - setup after build
- mapcn.dev (maps)

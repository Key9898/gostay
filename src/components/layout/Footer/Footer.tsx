      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid gap-8 md:gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            ...
            <div className="mt-6 flex items-center gap-2">
              <a href="#" className="btn btn-ghost btn-sm btn-circle" aria-label="Instagram">
                <Share2 className="h-4 w-4" />
              </a>
              <a href="#" className="btn btn-ghost btn-sm btn-circle" aria-label="Facebook">
          ...
          <div className="md:col-span-3">
            ...
            <p className="mt-4 text-sm text-base-content/70">{t('footer.newsletterDescription')}</p>
            <form className="mt-4 flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder="you@email.com"
                className="input input-bordered input-sm flex-1 rounded-full bg-base-100 text-sm"
              />
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-4 border-t border-base-300 pt-6 text-xs text-base-content/60 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-5">
            ...
            <span className="opacity-60">Made with ♥ in SEA</span>
          </div>
        </div>
      </div>
    </footer>

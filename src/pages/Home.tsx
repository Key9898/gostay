...
export default function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
      <SEO
        title="GoStay"
        description="Find rentals, roommates, and home kitchens across Myanmar and Thailand. A warm community platform for Southeast Asian living."
        jsonLd={{
          '@context': 'https://schema.org',
          '@type': 'WebSite',
          name: 'GoStay',
          url: 'https://gostay.app',
          potentialAction: {
            '@type': 'SearchAction',
            target: 'https://gostay.app/listings?q={search_term_string}',
      ...
      <section className="paper relative overflow-hidden">
        <div className="container mx-auto px-4 pt-10 pb-14 sm:pt-16 sm:pb-20 lg:pt-24 lg:pb-28">
          <div className="grid items-center gap-10 lg:grid-cols-12">
            <div className="lg:col-span-7">
              ...
              <h1 className="display mt-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-base-content">
                {t('home.hero.titleA')}{' '}
                <em className="not-italic text-primary">{t('home.hero.titleB')}</em>{' '}
                {t('home.hero.titleC')}
              </h1>
              <p className="mt-6 max-w-xl text-base sm:text-lg leading-relaxed text-base-content/75">
                {t('home.hero.sub')}
              </p>
              ...
              <div className="mt-8 rounded-2xl bg-base-100 p-2 shadow-xl ring-1 ring-base-300">
                <div className="flex flex-col md:flex-row md:items-center">
                  ...
                  <button className="btn btn-primary rounded-xl px-6 md:ml-2 w-full md:w-auto">
                    {t('common.search')}
                  </button>
                </div>
              </div>
            ...
            <div className="relative lg:col-span-5">
              <div className="relative h-[340px] sm:h-[420px] md:h-[460px]">
                <img
                  ...
                  className="absolute right-0 top-0 h-[220px] w-full rounded-3xl object-cover shadow-2xl ring-1 ring-base-300 sm:h-[280px] sm:w-[85%] md:h-[320px]"
                />
                <div className="absolute bottom-0 left-0 w-[70%] rounded-3xl bg-base-100 shadow-2xl ring-1 ring-base-300">
                  <div className="relative p-5 pb-12">
                    ...
                    <div className="absolute bottom-3 left-3 flex items-center gap-2 rounded-full bg-base-100 px-3 py-2 shadow-lg ring-1 ring-base-300">
          ...
          {/* Stats strip */}
          <div className="mt-12 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-[#E8DDC9] bg-[#E8DDC9] md:flex md:rounded-none md:border-0 md:bg-transparent md:border-y md:border-[#E8DDC9] md:py-8 md:divide-x md:divide-[#E8DDC9]">
            {[
              ...
              <div key={s.v} className="bg-[#FBF6EE] px-5 py-5 md:px-8 md:py-0 md:bg-transparent">
                <p className="display text-2xl sm:text-3xl md:text-4xl text-base-content">{s.k}</p>
                <p className="mt-1 text-xs sm:text-sm text-base-content/60">{s.v}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div className="max-w-xl">
              ...
              <h2 className="display mt-3 text-3xl md:text-4xl lg:text-5xl text-base-content">
                {t('home.pillarsSection.title')}
              </h2>
            </div>
            <p className="max-w-md text-base-content/70">{t('home.pillarsSection.sub')}</p>
          </div>

          <div className="mt-12 grid grid-cols-1 gap-px overflow-hidden rounded-3xl bg-base-300 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
            {pillars.map((p) => (
              <Link
                key={p.to}
                to={p.to}
                className="group bg-base-100 p-6 md:p-8 transition hover:bg-base-200"
              >
      ...
      {/* ===== FEATURED LISTINGS ===== */}
      <section className="bg-base-200/60 py-12 md:py-20 lg:py-28">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-secondary text-secondary-content">
            <div className="grid items-center gap-10 lg:grid-cols-2">
              <div className="p-10 lg:p-16">
                ...
                <h2 className="display mt-3 text-3xl md:text-4xl lg:text-5xl text-secondary-content">
      ...
      <section className="pb-14 md:pb-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="display mx-auto mt-4 max-w-2xl text-3xl md:text-4xl lg:text-5xl">
            {t('home.cta.title')}
          </h2>

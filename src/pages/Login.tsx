    ...
    <div className="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2">
      <div className="relative hidden lg:block">
        ...
        <div className="relative z-10 flex h-full flex-col justify-end p-14 text-secondary-content">
          ...
          <h2 className="display mt-3 text-4xl md:text-5xl leading-tight text-secondary-content">
            Your home, <em className="not-italic text-accent">our neighborhood.</em>
          </h2>
          <p className="mt-4 max-w-md text-secondary-content/85">
            Sign in to pick up where you left off — your saved listings, messages, and roommate
            matches.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 lg:p-14 bg-base-100">
        <div className="w-full max-w-md">
          ...
          <h1 className="display mt-2 text-3xl sm:text-4xl">{t('auth.loginTitle')}</h1>
          <p className="mt-2 text-sm sm:text-base text-base-content/70">{t('auth.loginSub')}</p>
